...
- [ ] `getBatchContext` 関数が実装されている
- [ ] 保護者AI生成がバッチコンテキストを使用
- [ ] 指導者AI生成がバッチコンテキストを使用
- [ ] プロンプトにバッチ対応ルールが追加されている
- [ ] 4科目まとめ記録でも適切な応援文が生成される
...
| ID | タスク | 担当 | 状態 | 備考 |
|----|--------|------|------|------|
| 1-1 | `getBatchContext` 関数作成 | - | 未着手 | `lib/utils/batch-context.ts` |
| 1-2 | 保護者AI生成にバッチコンテキスト適用 | - | 未着手 | `lib/openai/encouragement.ts` |
| 1-3 | 指導者AI生成にバッチコンテキスト適用 | - | 未着手 | `generateCoachAIEncouragement` |
| 1-4 | プロンプトにバッチ対応ルール追加 | - | 未着手 | `lib/openai/prompts.ts` |
| 1-5 | 動作確認（4科目まとめ記録で適切な応援文） | - | 未着手 | - |
...
| ID | タスク | 担当 | 状態 | 備考 |
|----|--------|------|------|------|
| 3-1 | `encouragement_sent` イベント拡張 | - | 未着手 | is_batch, subjects追加 |
| 3-2 | 分析SQLクエリ作成 | - | 未着手 | - |
