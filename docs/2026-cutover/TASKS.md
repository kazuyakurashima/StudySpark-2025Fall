...
- **ステータス**: `[ ]` Not started / `[~]` In progress / `[!]` Blocked / `[x]` Done
...
#### E1-T4: 環境識別バナー実装
- [x] **ステータス**: Done (components/environment-banner.tsx)
- **優先度**: P1
- **週目安**: 第1週
- **作業内容**:
...
- [~] **ステータス**: In progress (ドキュメント作成済み、チーム周知は未実施)
- **優先度**: P1
- **週目安**: 第1週
- **作業内容**:
...
- [~] **ステータス**: In progress (study_content_types 109件 + problem_counts 1,408件 投入済み)
- **優先度**: P0
- **週目安**: 第2週
- **作業内容**:
  - スクリプト実行
