-- ============================================================================
-- 20251108000001_update_sender_profiles_rpc_add_nickname.sql
-- 説明: get_sender_profiles RPC関数にnicknameとavatar_idを追加
-- ============================================================================
...
-- ============================================================================
-- RPC: 応援メッセージの送信者プロフィールを取得（nickname対応版）
-- ============================================================================
...
-- ============================================================================
-- RPC: 単一の送信者プロフィールを取得（nickname対応版）
-- ============================================================================
...
'応援メッセージ送信者の公開プロフィール情報（display_name, avatar_url, avatar_id, nickname）を安全に取得する。SECURITY DEFINER により RLS をバイパス。';
