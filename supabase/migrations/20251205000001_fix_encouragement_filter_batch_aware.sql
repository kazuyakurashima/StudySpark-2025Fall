...
-- ============================================================================
-- 作成日: 2025-12-05
-- 説明: 応援済み/未応援フィルターをバッチ単位で判定するように修正
--       バッチ内の代表ログにのみ応援が紐付けられる運用で、
--       残りのログが「未応援」と誤判定される問題を解消
...
BEGIN
  ...
  -- 応援済み/未応援フィルター（バッチ対応版）
  -- バッチの場合: 同じbatch_id内のどれかに応援があれば応援済み
  -- 単独ログの場合: 従来通りrelated_study_log_idでチェック
...
COMMENT ON FUNCTION public.get_study_logs_for_encouragement IS '応援機能用の学習記録一覧取得（バッチ対応版フィルター）';
