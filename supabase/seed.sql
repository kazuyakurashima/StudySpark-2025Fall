...
(5, 1,  '2024-09-01', '2024-09-07'),
(5, 2,  '2024-09-08', '2024-09-14'),
(5, 3,  '2024-09-15', '2024-09-21'),
(5, 4,  '2024-09-22', '2024-09-28'),
(5, 5,  '2024-09-29', '2024-10-05'),
(5, 6,  '2024-10-06', '2024-10-12'),
(5, 7,  '2024-10-13', '2024-10-19'),
(5, 8,  '2024-10-20', '2024-10-26'),
(5, 9,  '2024-10-27', '2024-11-02'),
(5, 10, '2024-11-03', '2024-11-09'),
(5, 11, '2024-11-10', '2024-11-16'),
(5, 12, '2024-11-17', '2024-11-23'),
(5, 13, '2024-11-24', '2024-11-30'),
(5, 14, '2024-12-01', '2024-12-07'),
(5, 15, '2024-12-08', '2024-12-14'),
(5, 16, '2024-12-15', '2024-12-21'),
(5, 17, '2024-12-22', '2024-12-28'),
(5, 18, '2025-01-05', '2025-01-11'),
(5, 19, '2025-01-12', '2025-01-18')
ON CONFLICT (grade, session_number) DO NOTHING;

-- 小学6年生: 15回（8/25 - 1/18）
INSERT INTO public.study_sessions (grade, session_number, start_date, end_date) VALUES
(6, 1,  '2024-08-25', '2024-08-31'),
(6, 2,  '2024-09-01', '2024-09-07'),
(6, 3,  '2024-09-08', '2024-09-14'),
(6, 4,  '2024-09-15', '2024-09-21'),
(6, 5,  '2024-09-22', '2024-09-28'),
(6, 6,  '2024-09-29', '2024-10-05'),
(6, 7,  '2024-10-06', '2024-10-12'),
(6, 8,  '2024-10-13', '2024-10-19'),
(6, 9,  '2024-10-20', '2024-10-26'),
(6, 10, '2024-10-27', '2024-11-02'),
(6, 11, '2024-11-03', '2024-11-09'),
(6, 12, '2024-11-10', '2024-11-16'),
(6, 13, '2024-11-17', '2024-11-23'),
(6, 14, '2024-12-01', '2024-12-07'),
(6, 15, '2025-01-12', '2025-01-18')
ON CONFLICT (grade, session_number) DO NOTHING;
...
BEGIN
  ...
  (v_test_type_id, 5, '2024-10-06', '2024-09-22', '2024-10-05'),
  (v_test_type_id, 6, '2024-11-03', '2024-10-20', '2024-11-02'),
  (v_test_type_id, 7, '2024-12-01', '2024-11-17', '2024-11-30'),
  (v_test_type_id, 8, '2025-01-12', '2024-12-22', '2025-01-11')
...
BEGIN
  ...
  (v_test_type_id, 3, '2024-09-08', '2024-08-25', '2024-09-07'),
  (v_test_type_id, 4, '2024-10-13', '2024-09-29', '2024-10-12'),
  (v_test_type_id, 5, '2024-11-10', '2024-10-27', '2024-11-09'),
  (v_test_type_id, 6, '2024-12-08', '2024-11-24', '2024-12-07')
  ON CONFLICT (test_type_id, test_number) DO NOTHING;
