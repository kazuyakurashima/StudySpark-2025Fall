...
BEGIN
  ...
  -- 第6回: 実施日 10/5, 目標設定 9/1〜10/31, 結果入力 10/5〜11/30
  (v_test_type_id, 6, '2025-10-05', '2025-09-01', '2025-10-31', '2025-10-05', '2025-11-30'),
  -- 第7回: 実施日 11/9, 目標設定 10/1〜11/30, 結果入力 11/9〜12/31
  (v_test_type_id, 7, '2025-11-09', '2025-10-01', '2025-11-30', '2025-11-09', '2025-12-31'),
  -- 第8回: 実施日 12/14, 目標設定 11/1〜12/31, 結果入力 12/14〜1/31
  (v_test_type_id, 8, '2025-12-14', '2025-11-01', '2025-12-31', '2025-12-14', '2026-01-31')
...
BEGIN
  ...
  -- 第3回: 実施日 9/7, 目標設定 8/1〜9/30, 結果入力 9/7〜10/31
  (v_test_type_id, 3, '2025-09-07', '2025-08-01', '2025-09-30', '2025-09-07', '2025-10-31'),
  -- 第4回: 実施日 10/5, 目標設定 9/1〜10/31, 結果入力 10/5〜11/30
  (v_test_type_id, 4, '2025-10-05', '2025-09-01', '2025-10-31', '2025-10-05', '2025-11-30'),
  -- 第5回: 実施日 11/16, 目標設定 10/1〜11/30, 結果入力 11/16〜12/31
  (v_test_type_id, 5, '2025-11-16', '2025-10-01', '2025-11-30', '2025-11-16', '2025-12-31'),
  -- 第6回: 実施日 12/7, 目標設定 11/1〜12/31, 結果入力 12/7〜2/28
  (v_test_type_id, 6, '2025-12-07', '2025-11-01', '2025-12-31', '2025-12-07', '2026-02-28')
  ON CONFLICT (test_type_id, test_number) DO NOTHING;
