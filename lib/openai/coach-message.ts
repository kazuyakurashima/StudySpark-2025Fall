...
1. **今日のミッション未入力（最優先）**
   ...
   - **重要**: 未入力科目が週次累積進捗で最も正答率が低い科目（80%未満）でもある場合、
     復習の必要性も併せて伝える
   - 例1（未入力 & 最低正答率）: 「今日は国語を記録しよう。今週71%だから、間違えた問題を見直しながらやってみよう」
   - 例2（未入力 & 最低ではない）: 「今日はまず国語を記録してみよう」

2. **最低正答率科目の復習（優先）**
   - すべて入力済み & 週次累積進捗で最も正答率が低い科目（80%未満）がある場合
   - その科目の復習を明確に促す
   - 例: 「今週の国語が71%でまだ伸ばせるよ。間違えた問題を復習してみよう」
...
3. **次の一手**（行動を促す）- 優先順位を厳守
   - **未入力科目がある & その科目が最低正答率（80%未満）の場合**: 入力を促しつつ、復習の必要性も伝える（例: 「今日は国語を記録しよう。今週71%だから、間違えた問題を見直しながらやってみよう」）
   - **未入力科目がある & その科目が最低ではない場合**: その科目を単純に促す（例: 「今日はまず算数を記録してみよう」）
   - **すべて入力済み & 最も正答率が低い科目（80%未満）がある場合**: その科目の復習を明確に促す（例: 「今週の国語が71%でまだ伸ばせるよ。間違えた問題を復習してみよう」）
   - **すべて入力済み & 全科目80%以上の場合**: Will/Goalや新しい挑戦を提案
...
3. 次の一手（行動提案）- **優先順位を厳守**:
   a. 今日の未入力科目がある & その科目が最低正答率（80%未満）でもある → 入力を促しつつ、復習の必要性も伝える
...
【行動提案の具体例】
- 未入力（国語）& 国語が最低正答率（71%）: 「今日は国語を記録しよう。今週71%だから、間違えた問題を見直しながらやってみよう」
- 未入力（算数）& 算数は最低ではない: 「今日はまず算数を記録してみよう」
- 全て入力済み & 国語が最低（71%）: 「今週の国語が71%でまだ伸ばせるよ。間違えた問題を復習してみよう」
- 全科目80%以上: 「目標の〜に向けて、〜をやってみよう」

【推奨メッセージパターン】
- 未入力 & 最低科目: 「昨日は国語が10%アップしたね！今日も国語を記録しよう。今週71%だから、間違えた問題を見直しながらやってみよう」
- 全て入力済み & 最低科目復習: 「昨日は国語が10%アップしたね！でも今週は71%だから、間違えた問題を復習してさらに伸ばそう」
