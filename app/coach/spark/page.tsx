...
const quickMessages = [
  "学習への取り組み姿勢が素晴らしいです。継続して頑張りましょう。",
  "解答プロセスがしっかりしています。この調子で応用問題にも挑戦しましょう。",
  "基礎力が着実に身についています。次のステップに進む準備ができていますね。",
  "集中力が向上しています。この努力が必ず結果に繋がります。",
  "質問する姿勢が積極的で良いですね。分からないことは遠慮なく聞いてください。",
]

export default function CoachSparkPage() {
